...
In unsupervised learning there no target/outcome of interest, there may a structure we want to try to understand. However, supervised learning  
...
A Descriptive model's main purpose involves describing characteristics of a dataset. Linear models, parameteric models 
...
The main purpose of an inferential model is to test a hypothesis. paramteric models 
:::
...
A Predictive model is used to make predictions useful for new data.
:::
...
A mechanistic model is a model which uses
...
An empirically driven model would be 
...
In machine leanring, regression problems the final predictions are in a quantitative results. Meanhwhile, for classification problems, 
...
Model tunning involves changing the hyperparameters of dif
